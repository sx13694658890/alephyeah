...
// api/address-generate/[country].ts
var UPSTREAM_BASE = "https://appark.ai/address-generate";
var corsHeaders = {
...
var onRequestOptions = /* @__PURE__ */ __name(async () => new Response(null, { status: 204, headers: corsHeaders }), "onRequestOptions");
var onRequestGet = /* @__PURE__ */ __name(async (context) => {
  const raw = String(context.params.country ?? "").trim().toLowerCase().replace(/\.json$/i, "");
  if (!ALLOWED.has(raw)) {
...
// api/apple-id-shared.ts
var UPSTREAM = "https://fanqiangnan.com/data_sync.php";
var corsHeaders2 = {
  "Access-Control-Allow-Origin": "*",
  "Access-Control-Allow-Methods": "GET, OPTIONS",
  "Access-Control-Allow-Headers": "Content-Type"
};
var onRequestOptions2 = /* @__PURE__ */ __name(async () => new Response(null, { status: 204, headers: corsHeaders2 }), "onRequestOptions");
...
// ../.wrangler/tmp/pages-ABw2AC/functionsRoutes-0.6726058103610779.mjs
var routes = [
  {

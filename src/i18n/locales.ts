...
export const messages = {
  en: {
    ...
    about: {
      ...
      effectsHintFireworks: 'Click to launch bursts. Open full screen for classic 2D mode.',
      ...
      effectFireworksDesc: '3D spatial bursts with colorful trails; classic 2D mode in full screen',
      effectRainWindow: 'Rain Window',
      effectRainWindowDesc: 'Heartfelt rain.glsl — refracted drops, foggy glass, and lightning',
    },
    fireworks: {
      back: 'Back to About',
      hint2d: 'Tap to launch · drag bottom edge for speed · P pause · O settings · M mute',
      hint3d: 'Tap to launch · P pause · switch mode for classic 2D canvas',
      modeToggle: 'Switch 2D / 3D mode',
      pause: 'Pause',
      play: 'Play',
      settings: 'Settings',
      close: 'Close',
  ...
  zh: {
    ...
    about: {
      ...
      effectsHintFireworks: '点击画面追加烟花，全屏可切换经典 2D 模式。',
      effectsHintRainWindow: '按住并上下拖动，可调节玻璃上的雨量大小。',
      effectsFullscreen: '全屏',
      effectsLoading: '加载特效中…',
      effectFireworks: '烟花',
      effectFireworksDesc: '3D 空间火花与拖尾，全屏可切换经典 2D 模式',
      effectRainWindow: '窗户雨',
      effectRainWindowDesc: 'rain.glsl 折射雨滴、雾面玻璃与闪电效果',
    },
    fireworks: {
      back: '返回关于页',
      hint2d: '点击燃放 · 底部滑动调速度 · P 暂停 · O 设置 · M 静音',
      hint3d: '点击燃放 · P 暂停 · 可切换经典 2D Canvas 模式',
      modeToggle: '切换 2D / 3D 模式',
      pause: '暂停',
      play: '播放',
      settings: '设置',
      close: '关闭',
